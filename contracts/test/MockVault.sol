...
contract MockVault {
    ...
    event MockPoolBalanceChanged(bool positive, uint256[] amounts, uint256[] dueProtocolFeeAmounts);
    ...
    function callJoinPool(
        ...
        emit MockPoolBalanceChanged(true, amountsIn, dueProtocolFeeAmounts);
    }
    ...
    function callExitPool(
        ...
        emit MockPoolBalanceChanged(false, amountsOut, dueProtocolFeeAmounts);
    }
}
