...
contract TBFixedPoint256 {
    ...
    function echidna_sub256_zero_identity() public returns (bool) {
        uint256 r1 = FixedPoint.sub(uint256_1, UINT256_ZERO);
        return r1 == uint256_1;
    }

    function echidna_sub256_self() public returns (bool) {
        uint256 r1 = FixedPoint.sub(uint256_1, uint256_1);
        return r1 == UINT256_ZERO;
    }

    function echidna_add256_commutative() public returns (bool) {
    ...
    function echidna_add256_associative() public returns (bool) {
        uint256 max = uint128(-1)/3;
        if (uint256_1 >= max || uint256_2 >= max || uint256_3 >= max) {
            return true;
        }
    ...
    function echidna_add256_zero_identity() public returns (bool) {
        uint256 r1 = FixedPoint.add(uint256_1, UINT256_ZERO);
        return r1 == uint256_1;
    }

    function echidna_mul256_zero() public returns (bool) {
        uint256 r1 = FixedPoint.mul(uint256_1, UINT256_ZERO);
        return r1 == UINT256_ZERO;
    }

    function echidna_mul256_commutative() public returns (bool) {
    ...
    function echidna_mul256_one() public returns (bool) {
        uint256 r1 = FixedPoint.mul(uint256_1, UINT256_ONE);
        return r1 == uint256_1;
    }

    function echidna_mul256_is_2add() public returns (bool) {
        uint256 r1 = FixedPoint.mul(2, uint256_1);
        uint256 r2 = FixedPoint.add(uint256_1, uint256_1);
        return r1 == r2;
    }

    function echidna_powi_mul2() public returns (bool) {
        if (uint256_1 == 1 || uint256_1 >= uint128(-1)) {
            return true;
        }
        uint256 r1 = FixedPoint.powi(uint256_1, 2);
        uint256 r2 = FixedPoint.mul(uint256_1, uint256_1);
        return r1 == r2;
    }

    function echidna_powi_mul3() public returns (bool) {
        if (uint256_1 >= uint64(-1)) {
            return true;
        }
        uint256 r1 = FixedPoint.powi(uint256_1, 3);
        uint256 r2 = FixedPoint.mul(uint256_1, FixedPoint.mul(uint256_1, uint256_1));
        return r1 == r2;
    }

    function echidna_powi_sqrt_mul() public returns (bool) {
        uint256 rx1 = FixedPoint.sqrt(uint256_1);

        uint256 r1 = FixedPoint.mul(rx1, rx1);
        uint256 r2 = FixedPoint.powi(rx1, 2);

        return equalWithTolerance(uint256_1, r1, 10 * 8);
    }

    function echidna_sqrt_precision() public returns (bool){
        if (uint256_1 == 0) {
            return true;
        }
        uint256 s = FixedPoint.sqrt(uint256_1);
