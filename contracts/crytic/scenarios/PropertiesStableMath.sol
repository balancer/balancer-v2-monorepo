...
contract PropertiesStableMath{
    ...
    **********************************************************************************************/
    function _calculateOneTokenSwapFee(
        ...
        uint256 y = ((inv - b) + Math.sqrt((inv - b) * (inv - b) + 4 * p)) / 2;
        return (balances[tokenIndex] - y - 1);
    } 

    function one_token_swap_positive_root(uint256 amp, uint256[] memory balances, uint256 lastInvariant, uint256 tokenIndex) public pure {
        uint256 one = 1 ether;
        uint256 sum = 0;
        for (uint256 i = 0; i < balances.length; i++) {
            sum = sum + balances[i];
        }
        require(amp > (one).div(LogExpMath.pow(sum, sum)));
    ...
    function _getAccumulatedSwapFees(uint256 _amp, uint256[] memory balances, uint256 _lastInvariant) internal pure returns (uint256[] memory) {
    ...
    function test_calculate_fee_difference(uint256 amp, uint256[] memory balances, uint256 lastInvariant, uint256 tokenIndex) public pure {
        uint256 one = 1 ether;
        uint256 sum = 0;
        for (uint256 i = 0; i < balances.length; i++) {
            sum = sum + balances[i];
    ...
    **********************************************************************************************/
    ...
    function in_given_out_positive_root(uint256 amp, uint256[] memory balances, uint256 tokenIndexIn, uint256 tokenIndexOut, uint256 tokenAmountOut) public pure {
        uint256 one = 1;
        uint256 sum = 0;
        for (uint256 i = 0; i < balances.length; i++) {
            sum = sum + balances[i];
    ...
    **********************************************************************************************/
    ...
    function out_given_in_positive_root(uint256 amp, uint256[] memory balances, uint256 tokenIndexIn, uint256 tokenIndexOut, uint256 tokenAmountIn) public pure {
        uint256 one = 1 ether;
        uint256 sum = 0;
        for (uint256 i = 0; i < balances.length; i++) {
            sum = sum + balances[i];
    ...
    **********************************************************************************************/
    ...
    function invariant_positive(uint256 amp, uint256[] memory balances) public pure {
        uint256 one = 1 ether;
        uint256 sum = 0;
        for (uint256 i = 0; i < balances.length; i++) {
            sum = sum + balances[i];
