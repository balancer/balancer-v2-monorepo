...
library Errors {
    ...
    uint256 internal constant EMERGENCY_WINDOW_EXPIRED = 403;
    uint256 internal constant MAX_RESPONSE_WINDOW = 404;
    uint256 internal constant MAX_BUFFER_PERIOD = 405;
