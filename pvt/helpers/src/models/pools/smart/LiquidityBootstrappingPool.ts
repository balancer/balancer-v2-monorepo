...
import LiquidityBootstrappingPoolDeployer from './LiquidityBootstrappingPoolDeployer';
...
import { encodeExitWeightedPool, encodeJoinWeightedPool } from '../weighted/encoding';
...
export default class LiquidityBootstrappingPool {
  instance: Contract;
  poolId: string;
  tokens: TokenList;
  ...
  static async create(params: RawLiquidityBootstrappingPoolDeployment = {}): Promise<LiquidityBootstrappingPool> {
    return LiquidityBootstrappingPoolDeployer.deploy(params);
  }
