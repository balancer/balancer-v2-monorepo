    ...
    return async function (this: any) {
      ...
      try {
        ...
        try {
          ...
          const regExp = /(Expected transaction to be reverted with )(.*)(, but other exception was thrown: .*Error: call revert exception; VM Exception while processing transaction: reverted with reason string )"(.*)" (.*)/;
