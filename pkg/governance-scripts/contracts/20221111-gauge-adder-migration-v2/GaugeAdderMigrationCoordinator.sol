...
contract GaugeAdderMigrationCoordinator is BaseCoordinator {
    ...
    function _setupOptimismGaugeType() private {
        ...
        bytes32 addGaugeTypeRole = getAuthorizerAdaptorEntrypoint().getActionId(IGaugeController.add_type.selector);
        ...
        getAuthorizerAdaptorEntrypoint().performAction(
    ...
    function _setupNewGaugeAdder() private {
        ...
        bytes32 addGaugeRole = getAuthorizerAdaptorEntrypoint().getActionId(IGaugeController.add_gauge.selector);
