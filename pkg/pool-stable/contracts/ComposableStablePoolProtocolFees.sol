    ...
    ProtocolFeeCache
{
    ...
    function _getProtocolPoolOwnershipPercentage(
        ...
        // Note: in the unexpected scenario where the rates of the tokens shrink over time instead of grow (i.e. if the
        ...
        // magnitude, it is possible for the Pool to either pay more or less protocol fees than it should.
        // Due to the complexity that handling all of these cases would introduce, this behavior is considered out of
        // scope, and is expected to be handled in a case-by-case basis if the token rates were to ever decrease (which
