...
abstract contract ManagedPoolSettings is BasePool, ProtocolFeeCache, IControlledManagedPool {
        ...
        )
    {
        ...
        _aumState = ManagedPoolAumStorageLib.setAumFeePercentage(_aumState, params.managementAumFeePercentage);
        ...
        _poolState = ManagedPoolStorageLib.setLPAllowlistEnabled(_poolState, params.mustAllowlistLPs);
        emit MustAllowlistLPsSet(params.mustAllowlistLPs);

        // If false, the pool will start in the disabled state (prevents front-running the enable swaps transaction).
        _poolState = ManagedPoolStorageLib.setSwapsEnabled(_poolState, params.swapEnabledOnStart);
