...
abstract contract LiquidityBootstrappingPoolSettings is IMinimalSwapInfoPool, NewBasePool {
    ...
    GradualValueChange.ValueChangeMode internal immutable _weightChangeMode;
    ...
    function _getWeightChangeMode() internal view returns (GradualValueChange.ValueChangeMode) {
        return _weightChangeMode;
    }
    ...
    function _getNormalizedWeights() internal view returns (uint256[] memory) {
        ...
        GradualValueChange.ValueChangeMode weightChangeMode = _weightChangeMode;
