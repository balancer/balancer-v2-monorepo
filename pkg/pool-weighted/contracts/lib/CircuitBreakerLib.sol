...
library CircuitBreakerLib {
    ...
    // and the current normalized weight. Since this value is bounded by 1e18, which fits in ~60 bits, there is no
    ...
    /**
     * @notice Update the cached ratios given a new normalized weight.
