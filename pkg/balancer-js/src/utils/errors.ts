const balancerErrorCodes: Record<string, string> = {
  ...
  '333': 'UNHANDLED_BY_LINEAR_POOL',
  '334': 'OUT_OF_TARGET_RANGE',
  '335': 'UNHANDLED_EXIT_KIND ',
  '336': 'UNAUTHORIZED_EXIT',
  '337': 'MAX_MANAGEMENT_SWAP_FEE_PERCENTAGE',
  '338': 'UNHANDLED_BY_INVESTMENT_POOL',
  '339': 'WEIGHT_CHANGE_RATE_TOO_HIGH',
  '340': 'WEIGHT_CHANGE_TIMELOCK',
  '400': 'REENTRANCY',
