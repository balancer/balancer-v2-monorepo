const balancerErrorCodes: Record<string, string> = {
  ...
  '331': 'MIN_CIRCUIT_BREAKER_RATIO',
  '332': 'MAX_CIRCUIT_BREAKER_RATIO',
  '333': 'INVALID_CIRCUIT_BREAKER_RATIOS',
  '334': 'CIRCUIT_BREAKER_TRIPPED_MIN_RATIO',
  '335': 'CIRCUIT_BREAKER_TRIPPED_MAX_RATIO',
  '336': 'WEIGHT_CHANGE_TOO_FAST',
  '337': 'LOWER_GREATER_THAN_UPPER_TARGET',
  '338': 'UPPER_TARGET_TOO_HIGH',
  '339': 'UNHANDLED_BY_LINEAR_POOL',
  '340': 'OUT_OF_TARGET_RANGE',
  '400': 'REENTRANCY',
