const balancerErrorCodes: Record<string, string> = {
  ...
  '331': 'MGMT_FEE_PERCENTAGE_TOO_HIGH',
  '332': 'WEIGHT_CHANGE_TOO_FAST',
  '333': 'LOWER_GREATER_THAN_UPPER_TARGET',
  '334': 'UPPER_TARGET_TOO_HIGH',
  '335': 'UNHANDLED_BY_LINEAR_POOL',
  '336': 'OUT_OF_TARGET_RANGE',
  '400': 'REENTRANCY',
