...
| Coordination of the Gauge Adder migration (v1->v2)  | [`20220721-gauge-adder-migration-coordinator`](./tasks/scripts/20220721-gauge-adder-migration-coordinator)       |
| Coordination of the Gauge Adder migration (v2->v3)  | [`20221111-gauge-adder-migration-coordinator-v2`](./tasks/scripts/20220721-gauge-adder-migration-coordinator-v2) |
