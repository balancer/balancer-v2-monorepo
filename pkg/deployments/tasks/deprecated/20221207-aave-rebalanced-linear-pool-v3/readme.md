...
>
> Superseded by [Aave Linear Pool V4](../../20230206-aave-rebalanced-linear-pool-v4/), which fixes the reentrancy issue described in this [forum post](https://forum.balancer.fi/t/reentrancy-vulnerability-scope-expanded/4345), and is compatible with AAVE V3 protocol.
