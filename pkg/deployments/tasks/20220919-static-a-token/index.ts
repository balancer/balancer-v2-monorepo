...
export default async (task: Task, { force, from }: TaskRunOptions = {}): Promise<void> => {
  ...
  if (deployer) {
    ...
    console.log('receiptInitialize?.events', receiptInitialize?.events);
    ...
    const implementation = await initializableAdminUpgradeabilityProxyContract.callStatic.implementation();
    console.log('implementation', implementation);
    const admin = await initializableAdminUpgradeabilityProxyContract.callStatic.admin();
