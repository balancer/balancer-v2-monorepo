...
describe('SturdyLinearPoolFactory', function () {
  ...
  sharedBeforeEach('deploy factory & tokens', async () => {
    ...
    factory = await deploy('SturdyLinearPoolFactory', {
    ...
    const wrappedTokenInstance = await deploy('MockSToken', { args: ['cDAI', 'cDAI', 18, mainToken.address] });
  ...
  describe('constructor arguments', () => {
    ...
    it('sets a rebalancer as the asset manager', async () => {
      ...
      const rebalancer = await deployedAt('SturdyLinearPoolRebalancer', assetManager);
