...
contract TetuLinearPoolFactory is ILastCreatedPoolFactory, BasePoolFactory, ReentrancyGuard, FactoryWidePauseWindow {
    ...
    ) BasePoolFactory(vault, protocolFeeProvider, type(TetuLinearPool).creationCode) {
        _queries = queries;
    }
    ...
    function create(
        ...
        TetuLinearPool.ConstructorArgs memory args = TetuLinearPool.ConstructorArgs({
            vault: getVault(),
            name: name,
            symbol: symbol,
            mainToken: mainToken,
