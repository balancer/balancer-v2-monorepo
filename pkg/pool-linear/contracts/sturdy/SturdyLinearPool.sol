...
contract SturdyLinearPool is LinearPool {
    ...
    {
        _lendingPool = ISToken(address(args.wrappedToken)).POOL();
        _require(
            address(args.mainToken) == ISToken(address(args.wrappedToken)).UNDERLYING_ASSET_ADDRESS(),
    ...
    function _getWrappedTokenRate() internal view override returns (uint256) {
        // This pulls in the implementation of `rate` used in the AToken contract
        // except avoiding storing relevant variables in storage for gas reasons.
        // solhint-disable-next-line max-line-length
        // see: https://github.com/sturdyfi/sturdy-contracts/blob/main/contracts/protocol/lendingpool/LendingPool.sol#L616-L624
