...
contract AaveLinearPoolFactory is ILastCreatedPoolFactory, BasePoolFactory, ReentrancyGuard {
    ...
    function create(
        ...
        args.basePoolParams = IBasePool.BasePoolParams({
            vault: getVault(),
            name: name,
            symbol: symbol,
        ...
        args.assetManager = deploymentParams.expectedRebalancerAddress;
