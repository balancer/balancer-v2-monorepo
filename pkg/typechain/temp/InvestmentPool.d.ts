...
interface InvestmentPoolInterface extends ethers.utils.Interface {
  functions: {
    ...
    "getMinimumWeightChangeDuration()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "getMinimumWeightChangeDuration",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export class InvestmentPool extends BaseContract {
  ...
  getMinimumWeightChangeDuration(overrides?: CallOverrides): Promise<BigNumber>;
