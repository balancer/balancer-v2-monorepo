...
import type {
  BalancerTokenAdmin,
  BalancerTokenAdminInterface,
} from "../BalancerTokenAdmin";
...
export class BalancerTokenAdmin__factory {
  static readonly abi = _abi;
  static createInterface(): BalancerTokenAdminInterface {
    return new utils.Interface(_abi) as BalancerTokenAdminInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): BalancerTokenAdmin {
    return new Contract(address, _abi, signerOrProvider) as BalancerTokenAdmin;
  }
}
