...
import type {
  ...
  VotingEscrowDelegationInterface,
} from "../VotingEscrowDelegation";
...
export class VotingEscrowDelegation__factory {
  static readonly abi = _abi;
  static createInterface(): VotingEscrowDelegationInterface {
    return new utils.Interface(_abi) as VotingEscrowDelegationInterface;
  }
  static connect(
    address: string,
