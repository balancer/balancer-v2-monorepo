...
interface StablePhantomPoolFactoryInterface extends ethers.utils.Interface {
  functions: {
...
export class StablePhantomPoolFactory extends BaseContract {
  ...
  interface: StablePhantomPoolFactoryInterface;
