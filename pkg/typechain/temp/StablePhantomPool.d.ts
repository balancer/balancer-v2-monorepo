...
interface StablePhantomPoolInterface extends ethers.utils.Interface {
  functions: {
...
export class StablePhantomPool extends BaseContract {
  ...
  interface: StablePhantomPoolInterface;
  ...
  filters: {
    ...
    ): TypedEventFilter<[BigNumber], {protocolSwapFeePercentage: BigNumber}>;

    DueProtocolFeeIncreased(
      bptAmount?: null
    ): TypedEventFilter<[BigNumber], {bptAmount: BigNumber}>;
