...
interface MetaStablePoolFactoryInterface extends ethers.utils.Interface {
  functions: {
    "create(string,string,address[],uint256,address[],uint256[],uint256,bool,address)": FunctionFragment;
...
export class MetaStablePoolFactory extends BaseContract {
  ...
  interface: MetaStablePoolFactoryInterface;
