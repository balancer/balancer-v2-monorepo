...
interface TestBalancerTokenInterface extends ethers.utils.Interface {
  functions: {
...
export class TestBalancerToken extends BaseContract {
  ...
  interface: TestBalancerTokenInterface;
