...
contract GnosisRootGaugeFactory is ISingleRecipientGaugeFactory {
    ...
    event GnosisRootGaugeCreated(address indexed gauge, address indexed recipient);

    constructor(IBalancerMinter minter, IGnosisBridge gnosisBridge) {
        _gaugeImplementation = new GnosisRootGauge(minter, gnosisBridge);
    }
    ...
    function create(address recipient) external override returns (address) {
        ...
        emit GnosisRootGaugeCreated(gauge, recipient);
