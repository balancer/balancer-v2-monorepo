...
import "./BalancerMinterBase.sol";

contract BalancerMinter is IBalancerMinter, BalancerMinterBase {
    ...
    constructor(IBalancerTokenAdmin tokenAdmin, IGaugeController gaugeController)
        BalancerMinterBase(tokenAdmin.getBalancerToken(), "Balancer Minter", "1")
    {
